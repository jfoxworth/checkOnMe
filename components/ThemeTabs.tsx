                ...
                <View className="z-10">
                    {type === 'scrollview' ? (
                        <ScrollView 
                            ...
                            horizontal 
                            className='flex-row h-[48px] bg-light-primary dark:bg-dark-primary border-b border-light-secondary dark:border-dark-secondary'
                        >
                            {tabs.map((tab, index) => {
                        ...
                        <View className='flex-row h-[48px] bg-light-primary dark:bg-dark-primary border-b border-light-secondary dark:border-dark-secondary'>
                            {tabs.map((tab, index) => {
                                if (!React.isValidElement(tab)) return null;
                                return (
                                    <Animated.View
